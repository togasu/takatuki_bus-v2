...
class DriverMessage(db.Model):
    ...
    driver_id = db.Column(db.Integer, nullable=False)  # driver serviceのdriver.id
    ...
    @classmethod
    def get_unreplied_count(cls):
        """未返信メッセージの数を取得"""
        return cls.query.filter_by(replied=False).count()
